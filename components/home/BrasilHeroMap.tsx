  ...
  return (
    <div className="relative hidden md:flex items-center justify-center">
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div className="h-[320px] w-[320px] rounded-full bg-brasil-blue/10 blur-3xl" />
      </div>

      <div className="relative w-full max-w-[460px] lg:max-w-[520px]">
        <div className="pointer-events-none absolute -left-10 top-8 z-10 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur-sm">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
            Transparência
          </p>
          <p className="mt-1 text-sm font-bold text-slate-900">Dados públicos</p>
        </div>

        <div className="pointer-events-none absolute -right-12 top-14 z-10 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur-sm">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
            Cobertura
          </p>
          <p className="mt-1 text-sm font-bold text-slate-900">Nacional</p>
        </div>

        <div className="pointer-events-none absolute -left-0 bottom-16 z-10 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur-sm">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
            Monitoramento
          </p>
          <p className="mt-1 text-sm font-bold text-slate-900">Câmara e Senado</p>
        </div>

        <div className="pointer-events-none absolute -right-10 bottom-10 z-10 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur-sm">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
            Indicadores
          </p>
          <p className="mt-1 text-sm font-bold text-slate-900">Gastos, votos e emendas</p>
        </div>
        ...
        <svg
          ...
          role="img"
          aria-label="Mapa do Brasil estilizado"
        >
          <g
            className="
              [&_.estado-path]:fill-brasil-blue
              [&_.estado-path]:stroke-white
          ...
          >
            ...
            <g className="estado" data-name="Pará" onClick={() => handleEstadoClick('PA')}>
              <path
                ...
                c-0.19-2.082-29.893-6.299-30.714-8.081C150.016,140.479,173.173,58.561,173.378,50.619z"
              />
