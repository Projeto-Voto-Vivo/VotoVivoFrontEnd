...
export function DeputadoCard({ deputado }: DeputadoCardProps) {
    return (
        <Link 
            ...
            className="group bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-xl hover:border-brasil-blue/30 transition-all duration-300 flex flex-col h-full"
        >
